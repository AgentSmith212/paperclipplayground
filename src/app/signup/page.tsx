    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black mt-2 mb-1">Create your account</h1>
          <p className="text-sm" style={{ color: "var(--foreground-muted)" }}>
            100 XP welcome bonus on sign up!
          </p>
        </div>
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-xs" style={{ color: "var(--foreground-muted)" }}>or</span>
          <div className="flex-1 h-px" style={{ background: "var(--border)" }} />
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="py-3 rounded-xl font-semibold transition-opacity hover:opacity-90 disabled:opacity-50"
